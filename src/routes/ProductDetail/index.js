              ...
              <div class="product__details__container">
                <ul class="product__small__images" role="tablist">
                  <li role="presentation" class="pot-small-img active">
                    <a href="#img-tab-1" role="tab" data-toggle="tab">
                      <img
                        src="/images/product-details/small-img/1.jpg"
                        alt="small-image"
                      />
                    </a>
                  </li>
                  <li role="presentation" class="pot-small-img">
                    <a href="#img-tab-2" role="tab" data-toggle="tab">
                      <img
                        src="/images/product-details/small-img/2.jpg"
                        alt="small-image"
                      />
                    </a>
                  </li>
                  <li role="presentation" class="pot-small-img hidden-xs">
                    <a href="#img-tab-3" role="tab" data-toggle="tab">
                      <img
                        src="/images/product-details/small-img/3.jpg"
                        alt="small-image"
                      />
                    </a>
                  </li>
                  <li
                    role="presentation"
                    class="pot-small-img hidden-xs hidden-sm"
                  >
                ...
                <div class="product__big__images">
                  <div class="portfolio-full-image tab-content">
                    ...
                    >
                      <img
                        src="/images/product-details/big-img/10.jpg"
                        alt="full-image"
                      />
                    ...
                    <div
                      role="tabpanel"
                      class="tab-pane fade product-video-position"
                      id="img-tab-2"
                    >
                      <img
                        src="/images/product-details/big-img/12.jpg"
                        alt="full-image"
                      />
                      {product.objectModel && render360ViewButton()}
                    </div>
                    ...
                    >
                      <img
                        src="/images/product-details/big-img/11.jpg"
                        alt="full-image"
                      />
                      {product.objectModel && render360ViewButton()}
                    </div>
